...
>
    ...
    <div class="h-64 m-6 bg-white rounded-xl shadow border border-gray-700 relative overflow-hidden">
        <div class="absolute bottom-20 transition-all duration-300 ease-linear"
             :style="`left: ${left}px`"
        >
